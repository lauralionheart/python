...
busqueda = re.findall(pattern,text,re.IGNORECASE)   #3er parametro que ignora si encuentra la palabra en minuscula o mayuscula
...
nueva_frase = re.sub(pattern,replacement,text)
print(nueva_frase)
